  ...
  tech: [
    {
      ...
      org: "Revature",
      date: "April 2026",
      img: "/certs/Java FullStack Certificate Revature.jpg",
      link: "/certs/Java FullStack Certificate Revature.jpg",
    },
    {
...
export default function Certificates() {
  ...
  return (
    <section className="container" style={{ padding: "10px 0" }}>
      <div className="card" style={{ background: "#111", borderRadius: 12, padding: 10 }}>
        <h2 style={{ fontSize: "1.8rem", color: "#fff", marginBottom: 2, }}>Certificates 🏅</h2>
