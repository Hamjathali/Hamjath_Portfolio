...
const ROWS = [
  [
    { title: "Core Concepts",items: ["Data Structures & Algorithms","Machine Learning","Deep Learning","Networking Fundamentals"]},
    { title: "Programming Languages", items: ["Python", "Java", "C"] },
    { title: "Frontend Development", items: ["HTML", "CSS", "JavaScript", "React"] },
    { title: "Backend Development", items: ["Java", "Spring Core", "Spring Boot", "REST APIs"] },
    { title: "Databases", items: ["PostgreSQL", "MySQL",] },
    { title: "AI / ML & Deep Learning", items: ["TensorFlow", "PyTorch", "CV", "YOLO", "Scikit-Learn"] },
    { title: "Networking & Security", items: ["Packet Analysis", "Scapy", "IDS (Intrusion Detection)", "Networking Fundamentals"] },
    { title: "Tools & Platforms", items: ["Git", "GitHub", "Postman", "Streamlit", "Wireshark", "VS Code", "Eclipse", ] },
