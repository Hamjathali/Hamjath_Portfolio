...
const SKILLS = [
  ...
  { name: "Postman", logo: "https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/postman.svg" },
...
const ROWS = [
  [
    { title: "Core Concepts",items: ["Data Structures & Algorithms", "OOP", "Microservices", "Machine Learning", "Deep Learning","Networking Fundamentals"]},
    { title: "Programming Languages", items: ["Java", "Python", "JavaScript", "C"] },
    { title: "Frontend Development", items: ["HTML", "CSS", "React"] },
    { title: "Backend Development", items: ["Spring Boot", "Spring Core", "REST APIs", "GraphQL", "Redis", "gRPC", "NGINX", "Kafka", "Docker"] },
    { title: "Databases", items: ["PostgreSQL", "MySQL",] },
    { title: "AI / ML & Deep Learning", items: ["TensorFlow", "PyTorch", "Computer Vision", "YOLO", "Scikit-Learn"] },
    { title: "Networking & Security", items: ["Networking Fundamentals", "Packet Analysis", "Scapy", "Intrusion Detection System (IDS)"] },
    { title: "Tools & Platforms", items: ["Linux (CLI)", "Git", "GitHub", "Postman", "Streamlit", "Wireshark", "VS Code", "Eclipse", ] },
    { title: "Soft Skills", items: ["Problem Solving", "Teamwork", "Communication", "Adaptability", "Creativity",  ]}]];
    ...
    <section className="skills-container" id="skills">
      ...
      >
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          ✨ Driven by innovation and equipped with versatile skills — here’s what I work with.
        </p>
      </motion.div>
