  ...
  return (
    ...
    >
      ...
      >
        ...
        and intelligent software applications. I work across frontend, backend,
        and database layers with hands-on experience in Java, Spring Boot,
      ...
      <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.85)", textAlign: "justify" }}>
        ...
        I've recently expanded into <strong>GraphQL</strong> for flexible, efficient
        API design and <strong>Redis</strong> for caching and improving application
        response times.
      </p>
      ...
      <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.85)", textAlign: "justify" }}>
        ...
        <strong>RiceGuard</strong>, a CNN-based crop disease detection system with
        92% accuracy. These projects sharpened my skills in data preprocessing,
      ...
      <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.85)", textAlign: "justify" }}>
        ...
        seeking opportunities to apply my skills, learn from industry projects,
        and contribute to impactful software or AI-driven products.
      </p>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={{margingBottom: "0.2"}}>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Graduated: 2026</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>2022</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>2020</p>
              </div>
            </motion.div>
          </div>
          ...
          <div
            ...
            >
              <FaBuilding size={60} color="var(--accent)" style={{ marginTop: "8px", flexShrink: 0 }} />
              <div>
                <h4
                  style={{
                    color: "var(--accent)",
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed: Jun 2026 – Present</p>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Performed web application testing and automation using Selenium with Python for validation.
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed: Dec 2024 – Jan 2025</p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Location: Chennai, Tamil Nadu</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Completed: June 2024 – July 2024</p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>Location: Chennai, Tamil Nadu</p>
              </div>
            </motion.div>
          </div>
